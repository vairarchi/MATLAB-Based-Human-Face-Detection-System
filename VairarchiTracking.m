...
%      VAIRARCHITRACKING, by itself, creates a new VAIRARCHITRACKING or raises the existing
%      singleton*.
%
%      H = VAIRARCHITRACKING returns the handle to a new VAIRARCHITRACKING or the handle to
%      the existing singleton*.
%
%      VAIRARCHITRACKING('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VAIRARCHITRACKING.M with the given input arguments.
%
%      VAIRARCHITRACKING('Property','Value',...) creates a new VAIRARCHITRACKING or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before VairarchiTracking_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      exit.  All inputs are passed to VairarchiTracking_OpeningFcn via varargin.
%
...
function VairarchiTracking_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to VairarchiTracking (see VARARGIN)
...
function varargout = VairarchiTracking_OutputFcn(hObject, eventdata, handles) 
